package com.lingc.coolapkconsole.activities;
...
import com.lingc.coolapkconsole.adapters.AppListAdapter;
import com.lingc.coolapkconsole.fragments.AboutFragment;
import com.lingc.coolapkconsole.model.AppItem;
import com.lingc.coolapkconsole.model.UserSave;
import com.lingc.coolapkconsole.utils.ACache;
import com.lingc.coolapkconsole.utils.ErrorUtils;
import com.lingc.coolapkconsole.utils.JsoupUtil;
import com.lingc.coolapkconsole.utils.Util;
import com.lingc.coolapkconsole.view.BezelImageView;
            ...
            if (requestPage <= mMaxPage) {
                try {
                    ...
                    for (Element element : mAppListElements) {
                        ...
                        Log.d("Tag",  tabElements.get(1).html().split("<br>")[1]);
                        String version;
                        if (!tabElements.get(1).html().split("<br>")[1].contains("信息不完整")) {
                            version = tabElements.get(1).html().split("<br>")[1].substring(0, tabElements.get(1).html().split("<br>")[1].indexOf("&nbsp;"));
                        } else {
                            version = "Unknown";
                        }
                        ...
                        String status = tabElements.get(4).text();
                        Log.d("Status", tabElements.get(4).text());
