...
public class AboutFragment extends AppCompatDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       // webSettings.setSupportZoom(true);
        ...
        // Before: https://raw.githubusercontent.com/TaRGroup/CoolApk-Console/master/README.md
        ...
        view.findViewById(R.id.layout_open_in_browser).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dismiss();
                try {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/HelloLingC/coolapk-developer-platform")));
